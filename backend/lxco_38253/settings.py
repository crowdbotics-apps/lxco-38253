"""
Django settings for lxco_38253 project.
...
WSGI_APPLICATION = 'lxco_38253.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lxco_38253 API",
    "DESCRIPTION": "API documentation for lxco_38253 App",
    "VERSION": "v1",
}
